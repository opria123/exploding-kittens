...
class _Loader extends EventsObject {
  imgs = [
    ...
    "assets/images/exploding-kittens-logo.png",
  ...
  audios = {
    music: [
      "assets/audio/bg-music/embrace-12278.mp3", 
      "assets/audio/bg-music/let-it-go-12279.mp3", 
      "assets/audio/bg-music/lofi-study-112191.mp3", 
      "assets/audio/bg-music/spirit-blossom-15285.mp3", 
      "assets/audio/bg-music/watr-fluid-10149.mp3"
  ],
